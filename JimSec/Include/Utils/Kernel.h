...
* We hebben 2 delete operators nodig omdat de STL delete operator 2 parameters heeft (pointer en size) 
* en de compiler genereert een delete operator met 1 parameter (pointer).
*/
